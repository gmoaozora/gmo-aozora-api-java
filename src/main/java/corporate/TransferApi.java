...
public class TransferApi {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call transferFeeUsingPOSTAsync(
        TransferRequest body, String xAccessToken, final ApiCallback<TransferFeeResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call transferRequestUsingPOSTAsync(
        TransferRequest body, String xAccessToken, final ApiCallback<TransferRequestResponse> callback) throws ApiException {
